...
/**
 * enum cuddlk_interrupt_handler_return_value - Interrupt handler return
 *                                              values.
 *
 ...
 *           from the ``cuddlk_interrupt_handler_return_value`` enumeration.
 *           If this field is set to ``NULL``, then no interrupt handler will
 *           be installed.  Typically a value of ``NULL`` only makes sense
 *           when setting ``irq`` to ``CUDDLK_IRQ_NONE`` or
 *           ``CUDDLK_IRQ_CUSTOM``.
 *
