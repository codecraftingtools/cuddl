...
/*
 * Cross-platform user-space device driver layer user-space device decls.
 *
...
/**
 * DOC: User-space device declarations.
 *
 * Cuddl devices are used to expose memory regions and event sources to
 * user-space applications.  The routines described here may be used to query
 * the device memory regions and event sources that have been made available
 * to user-space applications by Cuddl kernel drivers.
 *
 * This part of the API is only available to user-space code.
 */

/**
 * cuddl_manager_get_max_devices() - Get max number of managed devices.
 *
...
/**
 * cuddl_device_get_max_mem_regions() - Get max number of device mem regions.
 *
...
/**
 * cuddl_device_get_max_events() - Get max number of device event sources.
 *
...
/**
 * cuddl_device_get_mem_region_id() - Get ID describing a mem region by slot.
 *
...
/**
 * cuddl_device_get_event_id() - Get ID describing an event source by slot.
 *
